...
const CouponItem =[
  {
    img:'https://cdn.zeptonow.com/production/tr:w-64,ar-1968-1968,pr-true,f-auto,q-80/inventory/banner/e8ba8f4b-38cf-4100-9fa0-6c3e4eccf7a8.png',
    desciption:'Get assured rewards with CRED'
  },
   {
    img:'https://cdn.zeptonow.com/production/tr:w-64,ar-842-595,pr-true,f-auto,q-80/inventory/banner/c363f9b5-c88e-44a6-91f8-9aba7c338e48.png',
    desciption:'Get flat ₹25 discount with BHIM App'
  },
  
   {
    img:'https://cdn.zeptonow.com/production/tr:w-64,ar-400-400,pr-true,f-auto,q-80/app/bank-icons/v2/73bb8e2e-7204-4aed-bee0-842a3e0105ef.png',
    desciption:'Get up to ₹25 cashback using Amazon Pay Balance'
  },

   
   {
    img:'https://cdn.zeptonow.com/production/tr:w-64,ar-1000-1000,pr-true,f-auto,q-80/app/bank-icons/v2/a1688418-4528-491c-9636-10ac04ec15f5.png',
    desciption:'Up to ₹100 instant cashback using MobiKwik wallet at Zepto'
  },
]
...
{CouponItem.map((item,index)=>(
              ...
              <img src={item.img} alt='coupon image'/>
               </div>
               <p style={{fontSize:'14px',color:'#262a33',fontWeight:'450',textAign: 'left',margin:'0'}}>{item.desciption}</p>
               <span   style={{display:'block',verticalAlign:'middle'}}><MoreArrow/></span>
              </button>))}
